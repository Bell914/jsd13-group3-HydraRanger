...
export class ErrorBoundary extends Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div style={{ padding: 32, fontFamily: "Prompt, Kanit, system-ui, sans-serif", background: "#fcf4ee", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
